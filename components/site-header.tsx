...
export function SiteHeader() {
  return (
    <header className="flex h-[64px] shrink-0 items-center gap-2 border-b border-[#E2E8F0] bg-foreground rounded-tl-lg rounded-tr-lg transition-[width,height] ease-linear group-has-data-[collapsible=icon]/sidebar-wrapper:h-(--header-height) ">
