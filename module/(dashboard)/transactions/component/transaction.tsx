...
import { TransactionData } from "@/garbadge/transactionData"
import columns from "./columnsTransactions"
...
import { DraftFilterData } from "../../drafts/data/draftFilterData"
    ...
    <div className=" border bg-white p-4 space-y-4 mb-8">
      <div className="flex justify-end items-center">
        ...
        <div className="flex gap-2 items-center">
          ...
          <div>
            <Button variant="outline"  className=" h-7 bg-[#AEE485] rounded-[4px] hover:bg-[#cef4b0]">
            <p>Save Draft</p>
            <img src="savedraftbtn-arrow.svg" alt="" />
          </Button>
          </div>
        </div>
      </div>
